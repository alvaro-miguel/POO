...
import { Guerreiro, Mago, Arqueiro, Personagem } from "./personagem.js";
...
class App {
    ...
    private listarPersonagens(apenasVivos: boolean = false): void {
