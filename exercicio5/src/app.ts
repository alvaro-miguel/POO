...
export class App {
    ...
    private obterDadosConta(cliente: Cliente): Conta {
        ...
        return new Conta(id, numero, cliente, new Date(), saldoInicial);
    }
    ...
    private carregarDados(): void {
        ...
        const conta1 = new Conta(1, "0001", c1, new Date(), 1000.00);
        const conta2 = new Conta(2, "0002", c2, new Date(), 500.00);
        const conta3 = new Conta(3, "0003", c1, new Date(), 300.00);
